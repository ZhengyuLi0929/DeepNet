...
# protxt
model_def = './hybridCNN_deploy_upgraded.prototxt'

# load model
model_weights = './hybridCNN_iter_700000_upgraded.caffemodel'

# mean
mean_file = './hybridCNN_mean.npy'
...
Beach_good = '../Scene Images/fall 20/Scenes/good_beaches/flipped/'
Forest_good = '../Scene Images/fall 20/Scenes/good_forests/flipped/'
Highway_good = '../Scene Images/fall 20/Scenes/good_highways/flipped/'
Mountain_good = '../Scene Images/fall 20/Scenes/good_mountains/flipped/'
Office_good = '../Scene Images/fall 20/Scenes/good_offices/flipped/'
Beach_medium = '../Scene Images/fall 20/Scenes/medium_beaches/flipped/'
Forest_medium = '../Scene Images/fall 20/Scenes/medium_forests/flipped/'
Highway_medium = '../Scene Images/fall 20/Scenes/medium_highways/flipped/'
Mountain_medium = '../Scene Images/fall 20/Scenes/medium_mountains/flipped/'
Office_medium = '../Scene Images/fall 20/Scenes/medium_offices/flipped/'
Beach_bad = '../Scene Images/fall 20/Scenes/bad_beaches/flipped/'
Forest_bad = '../Scene Images/fall 20/Scenes/bad_forests/flipped/'
Highway_bad = '../Scene Images/fall 20/Scenes/bad_highways/flipped/'
Mountain_bad = '../Scene Images/fall 20/Scenes/bad_mountains/flipped/'
Office_bad = '../Scene Images/fall 20/Scenes/bad_offices/flipped/'
...
with open('flipped_good.json', 'w') as outfile1:
    json.dump(json_good, outfile1)
with open('flipped_medium.json', 'w') as outfile2:
    json.dump(json_medium, outfile2)
with open('flipped_bad.json', 'w') as outfile3:
