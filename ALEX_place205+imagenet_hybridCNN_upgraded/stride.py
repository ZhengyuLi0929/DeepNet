...
Beach_good = '../Scene Images/fall 20/Scenes/good_beaches/stride/'
Forest_good = '../Scene Images/fall 20/Scenes/good_forests/stride/'
Highway_good = '../Scene Images/fall 20/Scenes/good_highways/stride/'
Mountain_good = '../Scene Images/fall 20/Scenes/good_mountains/stride/'
Office_good = '../Scene Images/fall 20/Scenes/good_offices/stride/'
Beach_medium = '../Scene Images/fall 20/Scenes/medium_beaches/stride/'
Forest_medium = '../Scene Images/fall 20/Scenes/medium_forests/stride/'
Highway_medium = '../Scene Images/fall 20/Scenes/medium_highways/stride/'
Mountain_medium = '../Scene Images/fall 20/Scenes/medium_mountains/stride/'
Office_medium = '../Scene Images/fall 20/Scenes/medium_offices/stride/'
Beach_bad = '../Scene Images/fall 20/Scenes/bad_beaches/stride/'
Forest_bad = '../Scene Images/fall 20/Scenes/bad_forests/stride/'
Highway_bad = '../Scene Images/fall 20/Scenes/bad_highways/stride/'
Mountain_bad = '../Scene Images/fall 20/Scenes/bad_mountains/stride/'
Office_bad = '../Scene Images/fall 20/Scenes/bad_offices/stride/'
...
with open('stride_good.json', 'w') as outfile1:
    json.dump(json_good, outfile1)
with open('stride_medium.json', 'w') as outfile2:
    json.dump(json_medium, outfile2)
with open('stride_bad.json', 'w') as outfile3:
