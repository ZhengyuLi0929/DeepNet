...
for directory in directories:
    ...
    for filename in os.listdir(directory):
        if filename.endswith(".jpeg") or filename.endswith(".jpg"):
            ...
            conf_arr[0] += prediction[24+978]
            conf_arr[1] += prediction[64+978]
            conf_arr[2] += max(np.array([prediction[16+978], prediction[78+978], prediction[79+978], prediction[149+978]]))
            conf_arr[3] += max(np.array([prediction[94+978], prediction[95+978]]))
            conf_arr[4] += max(np.array([prediction[121+978], prediction[122+978]]))
            conf_arr[5] += max(np.array([prediction[93+978], prediction[129+978], prediction[130+978]]))
